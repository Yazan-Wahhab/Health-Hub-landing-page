...
// =========================================================================
// ✨ مكون المجسمات المتساقطة داخل الكروت (تبقى محصورة بالخلفية)
// =========================================================================
const FallingShapes = () => (
...
export default function ZigZagSections() {
  ...
  // خطوط التفرع العلوية من العنوان إلى الأجهزة
  ...
  return (
    <>
      <style dangerouslySetInnerHTML={{__html: `
        ...
        .animate-data-flow { animation: dataFlow 1s linear infinite; }
      ...
      <section ref={containerRef} className="relative h-[450vh] w-full bg-transparent z-10">
        <div className="sticky top-0 h-screen w-full overflow-hidden pointer-events-none">
          ...
          {/* =========================================================================
              العنوان الرئيسي العلوي (المنصة المركزية)
              ========================================================================= */}
          <motion.div
      ...
      {/* =========================================================================
          🔥 البوب أب (Light Frosted Gallery Modal)
          ========================================================================= */}
      <AnimatePresence>
        {activeGallery && (
          <motion.div 
          ...
          >
            ...
            {/* حاوية الصورة (بيضاء مع ظل أزرق احترافي) */}
            <motion.div 
              key={currentImgIndex}
            ...
            {/* المؤشرات والإرشاد (تصميم نظيف للفاتح) */}
