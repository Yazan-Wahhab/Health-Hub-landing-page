...
export default function HeroSection() {
  ...
  // 💻 Desktop Logo Path 
  // =========================================================================
  const dLogoX = useTransform(scrollYProgress, [0, 1], ["0vw", "-25vw"]);
  ...
  // 📱 Mobile Logo Path
  // =========================================================================
  const mLogoX = useTransform(scrollYProgress, [0, 1], ["0vw", "-30vw"]);
      ...
      <div className="w-full max-w-[1600px] mx-auto px-6 lg:px-12 grid lg:grid-cols-[1.2fr_0.8fr] gap-8 items-center relative z-10 lg:-translate-y-12">
        ...
        >
          ...
          <motion.div
            ...
            // 🔥 PRO FIX: Isolate heavy blurs onto their own composite layer
            className="relative mt-6 mr-6 overflow-hidden rounded-[2rem] p-7 max-w-2xl bg-gradient-to-br from-white/95 via-white/70 to-[var(--color-primary)]/10 backdrop-blur-2xl border border-white/80 shadow-[0_25px_50px_rgba(17,79,209,0.08),inset_0_2px_5px_rgba(255,255,255,0.9)] group will-change-transform transform-gpu [-webkit-backface-visibility:hidden]"
          >
        ...
        {/* 💻 Desktop Floating Logo - Fully GPU Accelerated */}
        <motion.div
        ...
        >
          <motion.div animate={{ y: [0, -15, 0] }} transition={{ duration: 6, repeat: Infinity, ease: "easeInOut" }} className="relative flex items-center justify-center">
            <div className="absolute w-[180%] h-[180%] rounded-full opacity-20" style={{ background: 'radial-gradient(circle, var(--color-secondary) 0%, transparent 60%)' }}></div>
            <div className="absolute w-[200%] h-[200%] rounded-full opacity-20 translate-x-5" style={{ background: 'radial-gradient(circle, var(--color-primary) 0%, transparent 60%)' }}></div>
            <img src="https://my.health-hubs.net/_next/image?url=%2Fassets%2Fimages%2Ffacicon.png&w=750&q=75" alt="Health Hub Logo" className="relative z-10 w-[32rem] h-[32rem] object-contain drop-shadow-[0_20px_30px_rgba(17,79,209,0.1)] grayscale-[10%]" />
          </motion.div>
        </motion.div>

        {/* 📱 Mobile Floating Logo - Fully GPU Accelerated */}
        <motion.div
          className="flex lg:hidden absolute right-[-15%] top-[10%] items-center justify-center z-0 pointer-events-none will-change-transform transform-gpu [-webkit-backface-visibility:hidden]"
          style={{ x: mLogoX, y: mLogoY, scale: mLogoScale, opacity: mLogoOpacity }}
        >
          <motion.div animate={{ y: [0, -15, 0] }} transition={{ duration: 6, repeat: Infinity, ease: "easeInOut" }} className="relative flex items-center justify-center">
            <div className="absolute w-[250%] h-[250%] rounded-full opacity-15" style={{ background: 'radial-gradient(circle, var(--color-secondary) 0%, transparent 60%)' }}></div>
            <div className="absolute w-[280%] h-[280%] rounded-full opacity-15 translate-x-5" style={{ background: 'radial-gradient(circle, var(--color-primary) 0%, transparent 60%)' }}></div>
            <img src="https://my.health-hubs.net/_next/image?url=%2Fassets%2Fimages%2Ffacicon.png&w=750&q=75" alt="Health Hub Logo" className="relative z-10 w-72 h-72 object-contain drop-shadow-[0_15px_25px_rgba(17,79,209,0.1)] grayscale-[10%]" />
          </motion.div>
        </motion.div>
