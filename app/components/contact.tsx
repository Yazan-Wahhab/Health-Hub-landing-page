    ...
    <div className="absolute inset-0 pointer-events-none z-0 overflow-hidden transform-gpu [-webkit-backface-visibility:hidden]">
      <motion.div
        animate={
          isMobile
            ? undefined
            : { y: [0, -30, 0], x: [0, 15, 0], rotate: [-10, 5, -10] }
        }
        transition={
          isMobile
            ? undefined
        ...
        className="hidden sm:flex absolute top-[15%] left-[8%] md:left-[12%] items-center justify-center w-16 h-16 md:w-20 md:h-20 rounded-[1.5rem] bg-white/60 backdrop-blur-md border border-white/80 shadow-[0_15px_35px_rgba(59,130,246,0.15)] will-change-transform transform-gpu"
      >
        <svg
          className="w-8 h-8 md:w-10 md:h-10 text-blue-500 drop-shadow-sm -rotate-12"
          fill="none"
          viewBox="0 0 24 24"
          stroke="currentColor"
        >
      ...
      <motion.div
        animate={
          isMobile
            ? undefined
            : { y: [0, 25, 0], x: [0, -10, 0], rotate: [0, -5, 0] }
        }
        transition={
          isMobile
            ? undefined
        ...
        className="hidden md:flex absolute bottom-[25%] right-[10%] items-center justify-center w-14 h-14 md:w-16 md:h-16 rounded-full bg-white/60 backdrop-blur-md border border-white/80 shadow-[0_15px_35px_rgba(16,185,129,0.15)] will-change-transform transform-gpu"
      >
        <svg
          className="w-6 h-6 md:w-8 md:h-8 text-emerald-500 drop-shadow-sm"
          fill="none"
          viewBox="0 0 24 24"
          stroke="currentColor"
        >
      ...
      <motion.div
        animate={
          isMobile
            ? undefined
            : { y: [0, -15, 0], scale: [1, 1.1, 1], rotate: [0, 15, 0] }
        }
        transition={
          isMobile
            ? undefined
        ...
        className="hidden lg:flex absolute top-[40%] right-[5%] items-center justify-center w-12 h-12 rounded-xl bg-white/60 backdrop-blur-md border border-white/80 shadow-[0_10px_25px_rgba(236,72,153,0.15)] will-change-transform transform-gpu"
      >
        <svg
          className="w-6 h-6 text-pink-500 drop-shadow-sm"
          fill="currentColor"
          viewBox="0 24 24"
        >
...
function ContactCard({
  ...
  return (
    ...
    >
      ...
      >
        <motion.div
          className="pointer-events-none absolute inset-0 z-10 opacity-0 transition-opacity duration-500 group-hover:opacity-100 mix-blend-multiply md:mix-blend-normal transform-gpu"
          style={isMobile ? undefined : { background: backgroundSpotlight }}
        />
        ...
        <div className="absolute inset-0 pointer-events-none z-0 overflow-hidden rounded-2xl md:rounded-[2rem] transform-gpu [-webkit-backface-visibility:hidden]">
          <motion.svg
            ...
            transition={
              isMobile
                ? undefined
                : { duration: floatDuration1, repeat: Infinity, ease: "linear" }
            }
            className="hidden md:block absolute -top-6 -right-4 w-20 h-20 text-[#86efac] opacity-50 will-change-transform transform-gpu"
            viewBox="0 0 24 24"
            fill="currentColor"
          >
          ...
          <motion.div
            ...
            transition={
              isMobile
                ? undefined
                : {
                    duration: floatDuration2,
                    repeat: Infinity,
                    ease: "easeInOut",
                  }
            }
            className="hidden md:block absolute -bottom-8 -left-6 w-24 h-24 rounded-full border-[5px] border-[#4ade80] opacity-30 will-change-transform transform-gpu"
          />

          <motion.svg
            animate={{ y: [0, -15, 0], rotate: [0, 90, 0] }}
            transition={{
              duration: floatDuration3,
              repeat: Infinity,
              ease: "easeInOut",
            }}
            className="absolute top-[20%] md:top-[25%] left-[15%] md:left-[20%] w-3 h-3 md:w-6 md:h-6 text-[#22c55e] opacity-40 will-change-transform transform-gpu"
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
          >
          ...
          <motion.div
            animate={isMobile ? undefined : { x: [-5, 15, -5], y: [0, 10, 0] }}
            transition={
              isMobile
                ? undefined
                : { duration: 5, repeat: Infinity, ease: "easeInOut" }
            }
            className="hidden md:block absolute bottom-[20%] right-[25%] w-2 h-2 bg-[#16a34a] rounded-full opacity-60 will-change-transform transform-gpu"
          />
        </div>

        <div className="relative z-20 flex flex-col items-center w-full">
          <div
            className={`mb-3 md:mb-5 flex items-center justify-center w-12 h-12 md:w-16 md:h-16 rounded-xl md:rounded-2xl bg-white shadow-sm transition-transform duration-500 group-hover:scale-110 group-hover:-translate-y-1 border border-green-200 ${channel.iconColor}`}
          >
            {channel.icon}
          </div>
        ...
        <div className="flex flex-col lg:flex-row justify-between gap-12 lg:gap-16 mb-16">
          ...
          <div className="w-full lg:w-[60%] flex flex-row flex-wrap sm:flex-nowrap justify-between gap-8 md:gap-12">
            <div className="w-full sm:w-1/2 grid grid-cols-2 gap-6 md:gap-12">
              <div>
                <h4 className="text-white font-bold mb-5 tracking-wide text-base">
                  {t("contact.system")}
                </h4>
          ...
          <div className="flex items-center gap-2 md:gap-3">
            {[
              ...
              <a
                key={i}
                href="#"
                className="w-8 h-8 md:w-10 md:h-10 rounded-full bg-[#1e293b] border border-slate-700/50 flex items-center justify-center text-slate-400 hover:bg-[#3b82f6] hover:text-white hover:border-[#3b82f6] hover:-translate-y-1 transition-all duration-300 shadow-sm"
              >
                <svg
...
export default function ContactAndFooterSection() {
  ...
  return (
    <>
      <section
        className="relative py-16 md:py-32 bg-transparent z-10"
        id="contact"
        dir="rtl"
      >
        ...
        <div className="mx-auto w-full max-w-[1400px] px-5 sm:px-8 lg:px-12 relative z-10">
          <div className="text-center max-w-3xl mx-auto mb-12 md:mb-20">
            <motion.div
              ...
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true, margin: "0px 0px -50px 0px" }}
              className="inline-flex items-center gap-2 bg-white/80 backdrop-blur-md border border-green-200/60 px-4 py-1.5 md:py-2 rounded-full mb-6 shadow-sm transform-gpu"
            >
              <span className="relative flex h-2 w-2">
                <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-green-500 opacity-75"></span>
                <span className="relative inline-flex rounded-full h-2 w-2 bg-green-500"></span>
              </span>
              <span className="text-[11px] md:text-xs font-bold text-green-800 uppercase tracking-wider">
                {t("contact.online")}
              </span>
            </motion.div>
            ...
            <motion.h2
              ...
              className="font-display text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold text-slate-900 mb-4 tracking-tight drop-shadow-sm transform-gpu"
            >
              {t("contact.heading")}
            </motion.h2>
          </div>
